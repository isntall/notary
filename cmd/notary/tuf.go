...
func (t *tufCommander) tufInit(cmd *cobra.Command, args []string) error {
	...
	rt, err := getAdminTransport(config, gun)
	if err != nil {
		return err
	}
...
// This RoundTripper cannot perform admin requests, such as creating and deleting repos
...
// and can be used for creating and deleting repos
